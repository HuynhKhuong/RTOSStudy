...
//\note DataLength = ID + DLC + Data + *
//\note number of signal = ID + Data
extern MessageLayout<4U, 2U> g_LEDControlMsg; 
extern MessageLayout<11U, 8U> g_RTCControlMsg; 
extern MessageLayout<4U, 2U> g_StateRespondMsg;
extern MessageLayout<6U, 4U> g_RTCRespondMsg;
